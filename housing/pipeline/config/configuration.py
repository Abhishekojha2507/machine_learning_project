...
class Configuration:
    ...
    def get_data_validation_config(self)-> get_data_Validation_config:
        try:
            artifact_dir=self.training_pipeline_config.artifact_dir
            ...
            report_page_path=os.path.join(data_validation_artifact_dir,
                                          data_validation_config[DATA_VALIDATION_REPORT_FILE_NAME_KEY]
                                          )
    ...
    def get_data_transformation_config(self)->get_data_Transformation_config:
        pass
